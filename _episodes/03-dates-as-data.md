...
> ## Exercise
>   
> Look at the tab 'dates' in the [messy data spreadsheet]({{ relative_root_path }}{% link /data/messy_survey_data.xls %}) you used in previous exercises. 
...
> ## Exercise
>   
> Look at the tab 'dates' in the [messy data spreadsheet]({{ relative_root_path }}{% link /data/messy_survey_data.xls %}). 
> It contains the copy the 'plot 3' table from the '2014' tab (this is the table that contains the problematic dates). 
...
> > ## Solution
> > 1. Click to the `dates` tab of the [messy data spreadsheet]({{ relative_root_path }}{% link /data/messy_survey_data.xls %}).   
