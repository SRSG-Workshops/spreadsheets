...
[messy data spreadsheet](/data/messy_survey_data.xls?raw=true). 
...
> ## Exercise    
> Set the 'plot_id' column in tab ‘semi-cleaned-combined’ of the [messy data spreadsheet](/data/messy_survey_data.xls?raw=true) 
> to only allow values that are integers between 1 and 24.
> > ## Solution
> > 1. Open the tab 'semi-cleaned-combined' of [messy data spreadsheet](/data/messy_survey_data.xls?raw=true) and select the 'plot_id' column.
...
> ## Exercise    
> Restrict the values of the 'species_id' column in tab ‘semi-cleaned-combined’ of the [messy data spreadsheet](/data/messy_survey_data.xls?raw=true) 
...
> ## Exercise   
>
> Look at the 'semi-cleaned-combined' tab of the [messy data spreadsheet](/data/messy_survey_data.xls?raw=true). It contains tables from the messy data tabs 
...
> [messy data spreadsheet](/data/messy_survey_data.xls?raw=true) and apply 
